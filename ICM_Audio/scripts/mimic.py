...
# model.add(Dense(samples, input_dim=latent_dim))
# model.add(Reshape((samples,1)))
# model.add(BatchNormalization())
# model.add(Activation("relu"))
# model.add(Conv1DTranspose(filters=16, kernel_size=kernel_len, strides = 4, padding="same"))
# model.add(BatchNormalization())
# model.add(Activation("relu"))
# model.add(Conv1DTranspose(filters=1, kernel_size=kernel_len, strides = 4, padding="same"))
# model.add(BatchNormalization())
# model.add(Activation("sigmoid")) 
#model.add(Reshape((samples * 4,1))

#model.add(Dense(samples, activation='tanh', input_dim=latent_dim))
#model.add(Reshape([samples,1]))
